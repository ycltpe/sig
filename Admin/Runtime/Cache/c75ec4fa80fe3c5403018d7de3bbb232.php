			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
                        <label class="ui-form-label" for="J-start">商品：</label>
						...
						<div class="ui-form-content">
							<input type="text" value="" name="search_store_name" class="ui-input i-date" id="J-start">
						</div>
                        ...
                        <div class="submit-time-container ">
							...
							<input type="button" value="新增商品" style="margin-left:530px" class="BigButtonBHover" onClick="javascript:window.location = '__URL__/add'">
						</div>
                    </div>
                 </div>             
			  </div>
                            ...
                            <div class="ui-tab-trigger"> 
                                <ul class="fn-clear"> 
                                    <li class="ui-tab-trigger-item  ui-tab-trigger-item-current">
                                        <a href="__URL__/index" class="ui-tab-trigger-text">商品信息</a></li>
                            ...
                            <div class="ui-tab-container" id="myScene">
                                <div class="ui-tab-container-item ui-tab-container-item-current">
                                    ...
                                    <table id="tradeRecordsIndex" class="ui-table">
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vs): ?><tr >
                                                ...
                                                <td ><?php echo ($vs["store_name"]); ?></td>
                                                <td ><?php echo ($vs["cn_name"]); ?></td>
                                                <td ><?php echo ($vs["brand_name"]); ?></td>
                                                <td ><?php echo ($vs["category_name"]); ?></td>
                                ...
                                <div class="fn-clear">
                                    ...
                                    <div class="iconTip fn-left" style="padding-left:15px;">
                                        ...
                                        <a href="javascript:document:update.submit();">保存到数据库2</a>
                                    </div>
