			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
                        <label class="ui-form-label" for="J-start">商家编号：</label>
						<div class="ui-form-content">
							<input type="text" value="" name="search_id" class="ui-input i-date" id="J-start">
						</div>
						<label class="ui-form-label" for="J-start">商家名称：</label>
						<div class="ui-form-content">
                        ...
                        <div class="submit-time-container ">
							...
							<input type="button" value="新增商店" style="margin-left:530px" class="BigButtonBHover" onClick="javascript:window.location = '__URL__/add'">
						</div>
                    </div>
                 </div>             
			  </div>
                            ...
                            <div class="ui-tab-trigger"> 
                                <ul class="fn-clear"> 
                                    <li class="ui-tab-trigger-item  ui-tab-trigger-item-current">
                                        <a href="__URL__/index" class="ui-tab-trigger-text">商店信息</a></li>
                            ...
                            <div class="ui-tab-container" id="myScene">
                                    ...
                                    <table id="tradeRecordsIndex" class="ui-table">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="240">商家名称（中文）</th>
                                                <th width="240">商家名称（英文）</th>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vs): ?><tr >
                                                ...
                                                <td ><?php echo ($vs["cn_name"]); ?></td>
                                                <td ><?php echo ($vs["en_name"]); ?></td>
                                                ...
                                                <td ><a href="__URL__/commentList/id/<?php echo ($vs["id"]); ?>">查看</a></td>									
                                ...
                                <div class="fn-clear">
                                    ...
                                    <div class="iconTip fn-left" style="padding-left:15px;">
                                        ...
                                        <a href="javascript:document:update.submit();">保存到数据库1</a>
