            ...
            <div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
                <div class="ui-grid-21" coor="content">
                    <div class="ui-grid-21 ui-grid-right record-tit" coor="title">
                        <h2 class="ui-tit-page">菜单信息</h2>
                        <div class="record-tit-amount">
                        </div>
                    </div>

                    <!-- 过滤表单 -->
                    <form method="get" action="__URL__/index" name="topSearchForm" class="ui-grid-21 ui-grid-right ui-form">
                            ...
                            <div id="J-advanced-filter-option" class="">
                                <div class="record-search-time fn-clear">
                                    <div class="ui-form-item ui-form-item-time">
                                        <label class="ui-form-label" for="J-start">菜单名称：</label>
                                        <div class="ui-form-content">
                                            <input type="text" value="" name="search_name" class="ui-input i-date" id="J-start">
                                        </div>
                                        ...
                                        <div class="submit-time-container ">
                                            ...
                                            <input type="button" value="新增菜单" style="margin-left:530px" class="BigButtonBHover" onClick="javascript:window.location = '__URL__/add'">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ui-tab-trigger">
                                <ul class="fn-clear">
                                    <li class="ui-tab-trigger-item  ui-tab-trigger-item-current">
                                        <a href="__URL__/index" class="ui-tab-trigger-text">菜单信息</a></li>
                            ...
                            <div class="ui-tab-container" id="myScene">
                                <div class="ui-tab-container-item ui-tab-container-item-current">
                                    ...
                                    <table id="tradeRecordsIndex" class="ui-table">
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="checkbox" width="20">
                                                    <input type="checkbox" class="checkbox" value="1" name="chkall" onClick="check_all(this)" /></th>
                                                <th width="100"><a href="__URL__/index?_sort=<?php echo ($sort); ?>">菜单编号</a></th>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vs): ?><tr >
                                                <td class="checkbox">
                                                    <input type="checkbox" name="id[]" value="<?php echo ($vs["id"]); ?>" class="checkbox" />
                                                </td>
                                                <td ><?php echo ($vs["id"]); ?></td>
                                                <td ><a href="__URL__/index?p_id=<?php echo ($vs["id"]); ?>"><?php echo ($vs["name"]); ?></a></td>
                                                <td >&nbsp;</td>
                                                <td ><a href="__URL__/add/p_id/<?php echo ($vs["id"]); ?>">添加子菜单</a> |
                                                    <a href="__URL__/edit/id/<?php echo ($vs["id"]); ?>">编辑</a> |
                                                    <a href="__URL__/editclass/id/<?php echo ($vs["id"]); ?>">移动</a> |
                                                    <a href="__URL__/delete/id/<?php echo ($vs["id"]); ?>">删除</a></td>
