            ...
            <table class="TableBlock" border="0" width="90%" align="center">
                <tr>
                    ...
                    <td align="left" class="TableData">
                        <input type="text" class="BigInput" id="name" name="name" value="" datatype="*" nullmsg="请输入菜单名称！" errormsg="请输入菜单名称！" > <div style="display:inline;" class="Validform_checktip"></div> 
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" class="TableData">
                        <SELECT name="channeltype" datatype="*" nullmsg="请选择菜单属性！">
                            ...
                            <option value="1">最终列表菜单</option>
                            <option value="2">频道封面</option>
                ...
                <tr>
                    ...
                    <td align="left" class="TableData">
                        <input type="text" class="BigInput" id="sortrank" name="sortrank" value="0" > 
                    </td>
                </tr>
                <tr>
                ...
                <tr align="center" class="TableControl">
                    <td colspan="2" nowrap height="35">
                        <!-- onclick="sendForm();" -->
                        <input type="hidden" class="medium bLeft" name="p_id" value="<?php echo ($p_id); ?>">
