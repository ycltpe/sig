				...
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
                        ...
                        <div class="submit-time-container ">
							<input type="button" value="   新增幻灯片" style="margin-left:970px" class="BigButtonBHover" onClick="javascript:window.location = '__URL__/add'">
						</div>
                    </div>
                 </div>             
			  </div>
                                ...
                                <div class="ui-tab-container-item ui-tab-container-item-current">
                                    ...
                                    <table id="tradeRecordsIndex" class="ui-table">
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vs): ?><tr >
                                                ...
                                                <th width="50"><?php echo ($vs["id"]); ?></th>
                                                <th width="180"><?php echo ($vs["pic_name"]); ?></th>
                                                <th width="200"><?php echo (toDate($vs["create_time"],'Y-m-d H:i:s')); ?></th>
                                                <th width="130"><?php echo ($vs["store_name"]); ?></th>
