			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
                        <label class="ui-form-label" for="J-start">城市名称：</label>
                        ...
                        <div class="submit-time-container ">
							...
							<input type="button" value="新增城市" style="margin-left:730px" class="BigButtonBHover" onClick="javascript:window.location = '__URL__/add'">
						</div>
                    </div>
                 </div>             
			  </div>
                            ...
                            <div class="ui-tab-trigger"> 
                                <ul class="fn-clear"> 
                                    <li class="ui-tab-trigger-item  ui-tab-trigger-item-current">
                                        <a href="__URL__/index" class="ui-tab-trigger-text">城市信息</a></li>
