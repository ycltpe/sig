        ...
        <div id="container" class="ui-container">
			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
                        <label class="ui-form-label" for="J-start">订单号：</label>
						<div class="ui-form-content">
							<input type="text" value="" name="search_order_no" class="ui-input i-date" id="J-start">
						</div>
						<label class="ui-form-label" for="J-start">ID：</label>
						<div class="ui-form-content">
                        ...
                        <div class="submit-time-container ">
							...
							<input type="hidden" value="新增订单" style="margin-left:530px" class="BigButtonBHover" onClick="javascript:window.location = '__URL__/add'">
						</div>
                    </div>
                 </div>             
			  </div>
			...
			<div>
				<table style="text-align: center;width: 100%;">
					<tr>
						<td><b>购物总金额</b>：￡<?php echo ($all_amount); ?></td>
						<td><b>呈现用户返利总金额</b>：￡<?php echo ($all_user_rebate); ?></td>
						<td><b>商家提供返利总金额</b>：￡<?php echo ($all_store_rebate); ?></td>
						<td><b>利润</b>：￡<?php echo ($all_profit); ?></td>
					</tr>
				</table>
            </div>
                   <!-- .record-search -->
                            ...
                            <div class="ui-tab-trigger"> 
                                <ul class="fn-clear"> 
                                    <li class="ui-tab-trigger-item  ui-tab-trigger-item-current">
                                        <a href="__URL__/index" class="ui-tab-trigger-text">订单信息</a></li>
                            ...
                            <div class="ui-tab-container" id="myScene">
                                    ...
                                    <table id="tradeRecordsIndex" class="ui-table">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="80">商家状态</th>
                                                <th width="80">用户状态</th>
                                                <th width="100">购物金额</th>
                                                <th width="100">订单商品</th>
                                                <th width="140">操作</th>
                                            </tr>
                                        </thead>						
                                        <tbody>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vs): ?><tr >
                                                ...
                                                <td ><?php echo ($vs["order_no"]); ?></td>
                                                <td ><?php echo (toDate($vs["update_time"],'Y-m-d H:i:s')); ?></td>
                                                <td ><?php echo ($vs["user_id"]); ?></td>
                                                <td ><?php echo ($vs["user_name"]); ?></td>
                                                <td ><?php echo ($vs["store_address"]); ?></td>
                                                <td ><?php echo ($vs["type"]); ?></td>
                                                <td ><?php echo ($vs["status"]); ?></td>
                                                <td >￡<?php echo ($vs["amount"]); ?></td>
                                                <td ><a href="__URL__/commodityList/id/<?php echo ($vs["id"]); ?>">查看</a></td>
                                                <td ><a href="__URL__/show/id/<?php echo ($vs["id"]); ?>">查看</a> | <a href="__URL__/edit/id/<?php echo ($vs["id"]); ?>">编辑</a><?php if($vs["status"] == '等待回扣' ): ?>| <a href="__URL__/confirm/id/<?php echo ($vs["id"]); ?>">确认回扣</a><?php endif; ?></td>									
                                ...
                                <div class="fn-clear">
                                    ...
                                    <div class="iconTip fn-left" style="padding-left:15px;">
                                        ...
                                        &nbsp;
                                        <a class="js-add-copy"><span></span></a>
                                        <a href="javascript:document:update.submit();">复制订单</a>
                                        
                                        &nbsp;
                                        <a class="js-add-backup"><span></span></a>
                                        <a href="javascript:document:update.submit();">保存到数据库3</a>
