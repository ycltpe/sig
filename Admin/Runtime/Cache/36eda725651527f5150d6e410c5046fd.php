    ...
    <body>
        ...
        <form name="save" class="registerform" method="post" action="__URL__/update" enctype="multipart/form-data">
            <table class="TableBlock" border="0" width="90%" align="center">
                <tr>
                    <td align="left" class="TableContent" width="15%"> 您选择的菜单名称：</td>
                    <td align="left" class="TableData"><?php echo ($vo["name"]); ?>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="TableContent" width="15%"> 你希望移动到那个菜单名称？：</td>
                    <td align="left" class="TableData">
                        <SELECT name="p_id">
                            <option value="0">移动为顶级菜单</option>
                            <?php optionFenlei($arr);?>
                        </SELECT>
                    </td>
                </tr>
                <tr align="center" class="TableControl">
                    <td colspan="2" nowrap height="35">
                        <!-- onclick="sendForm();" -->
                        <input type="hidden" class="medium bLeft" name="id" value="<?php echo ($id); ?>">
